...
type PoolsWithoutLinearQueryVariables = Exact$1<{
    skip?: InputMaybe$1<Scalars$1['Int']>;
    first?: InputMaybe$1<Scalars$1['Int']>;
    orderBy?: InputMaybe$1<Pool_OrderBy$1>;
    orderDirection?: InputMaybe$1<OrderDirection$1>;
...
type PoolWithoutLinearQueryVariables = Exact$1<{
    id: Scalars$1['ID'];
    block?: InputMaybe$1<Block_Height$1>;
}>;
type PoolWithoutLinearQuery = {
    __typename?: 'Query';
    pool?: {
        __typename?: 'Pool';
        id: string;
 ...
 */
interface PoolWithMethods extends Pool, ParamsBuilder {
...
type ExitPoolData = ExitPoolRequest & EncodeExitPoolInput;
type JoinPoolData = JoinPoolRequest & EncodeJoinPoolInput;
...
declare class ImpermanentLossService {
     ...
     */
    calcImpLoss(timestamp: number, pool: Pool): Promise<number>;
     ...
     */
    prepareData(entryTimestamp: number, pool: Pool): Promise<Asset[]>;
...
type JoinAction = 'input' | 'batchSwap' | 'wrap' | 'joinPool' | 'wrapAaveDynamicToken' | 'wrapERC4626';
type ExitAction = 'output' | 'batchSwap' | 'unwrap' | 'exitPool' | 'unwrapAaveStaticToken' | 'unwrapERC4626';
...
declare class Pools implements Findable<PoolWithMethods> {
     ...
     * @returns
     */
    impermanentLoss(timestamp: number, pool: Pool): Promise<number>;
    /**
