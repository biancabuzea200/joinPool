import { parseFixed, formatFixed, BigNumber as BigNumber$1 } from '@ethersproject/bignumber';
...
class WeightedPool {
    ...
    _calcTokensOutGivenExactBptIn(bptAmountIn) {
        ...
        try {
            ...
            return returnAmt.map((a) => BigNumber$1.from(a.toString()));
        }
        catch (err) {
...
class StablePool {
    ...
    _calcTokensOutGivenExactBptIn(bptAmountIn) {
        ...
        const balancesEvm = this.tokens
            .filter((t) => !isSameAddress(t.address, this.address))
            .map(({ balance, decimals }) => parseFixed(balance, decimals).toBigInt());
        let returnAmt;
        try {
...
class MetaStablePool {
    ...
    _calcTokensOutGivenExactBptIn(bptAmountIn) {
        ...
        const balancesEvm = this.tokens
            .filter((t) => !isSameAddress(t.address, this.address))
            .map(({ balance, priceRate, decimals }) => parseFixed(balance, 18)
...
class PhantomStablePool {
    ...
    _calcBptOutGivenExactTokensIn(amountsIn) {
        try {
            ...
            const balancesEvm = this.tokens
                .filter((t) => !isSameAddress(t.address, this.address))
                .map(({ balance, priceRate, decimals }) => parseFixed(balance, decimals)
...
class SwapCostCalculator {
     ...
     */
    convertGasCostToToken(tokenAddress, tokenDecimals, gasPriceWei, swapGas = BigNumber$1.from('85000')) {
        return __awaiter(this, void 0, void 0, function* () {
